  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <div className="mb-12">
          ...
          <p className="font-rubik text-lg md:text-xl text-[#DC1F73] font-bold max-w-2xl mx-auto leading-relaxed">Crée ton voyage autour d'un festival avec l'IA. 
Personnalisé, devis instantané, réservation fluide.</p>
        </div>
